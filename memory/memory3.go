...
// MemoryThree is a type to demonstrate memory optimization and garbage collector management in Go.
// go tool trace trace.out - to see memory usage
...
type MemoryThree struct{}

func (m *MemoryThree) Start() {
